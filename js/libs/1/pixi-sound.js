 ...
 * Compiled Fri, 26 Apr 2019 07:11:26 UTC
 *
...
(function (global, factory) {
  ...
  ***************************************************************************** */
  ...
  var WebAudioInstance = (function (_super) {
      ...
      WebAudioInstance.prototype.Speed = function (speed) {
      ...
      WebAudioInstance.prototype.Volume = function (volume) {
      ...
      WebAudioInstance.prototype.Loop = function (loop) {
          this._loop = loop;
          this.refresh();
          return this;
      };
  ...
  var WebAudioNodes = (function (_super) {
      ...
      function WebAudioNodes(context) {
          ...
          var script = audioContext.createScriptProcessor(0);
