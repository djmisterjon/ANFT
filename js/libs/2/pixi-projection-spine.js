...
(function (pixi_projection) {
    ...
    (function (AFFINE) {
        ...
        AFFINE[AFFINE["ISO_R"] = 6] = "ISO_R"; //FIXME: TEST
        ...
        Matrix3d.prototype.copy = function (matrix, affine, preserveOrientation) {
            ...
            if (affine >= 2) {
                ...
                if (affine === pixi_projection.AFFINE.POINT) {
                    ...
                    matrix.a = D;
                    matrix.c = 0;
                }else if (affine ===  pixi_projection.AFFINE.AXIS_XR) {
                    matrix.a = matrix.d ;
                    matrix.c = -matrix.b ;
                }
                else if (affine ===  pixi_projection.AFFINE.ISO_R) {
                    D /= Math.sqrt(matrix.a * matrix.a + matrix.c * matrix.c);
                    matrix.d = D;
                    matrix.a*=matrix.a;
                }
